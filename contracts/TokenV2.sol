...
contract TokenV2 is ERC20 {
    ...
    constructor(address _owner) {
        ...
        currentIssuance = HubV2I(hub).issuance();
        _mint(_owner, HubV2I(hub).signupBonus());
    }
    ...
    function look() public view returns (uint256) {
        ...
        while (clock.add(offset) <= time()) {
            ...
            rate = HubV2I(hub).issuanceByStep(p);
        }
    ...
    function migrateMint(address to, uint256 amount) public onlyHub {
        _mint(to, amount);
    }
